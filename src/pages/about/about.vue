<template>
	<view class="about test-background">
		...
		<view class="content">
			<view class="source">
				<view class="title" style="font-weight:900">此项目是uni-app的头条小程序解耦构建示例项目，可以将uni-app项目打包成为一个解耦包，集成到任何一个原生小程序项目中</view>
				<view class="title" style="font-weight:900;color:darkred">在原来uni项目的基础上，使用uniapp2wxpack的cli升级成解耦构造的头条小程序项目</view>
